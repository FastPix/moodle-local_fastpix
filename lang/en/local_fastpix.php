...
$string['task_backfill_asset_owners'] = 'Backfill asset owners from upload sessions';
$string['task_orphan_sweeper'] = 'Sweep expired upload sessions';
$string['task_release_unattached_assets'] = 'Release ready videos not attached to any activity';
$string['task_reconcile_pending_assets'] = 'Reconcile stuck videos with FastPix (missed-webhook backfill)';
...
$string['privacy:metadata:upload_session:courseid']     = 'The course the upload was started in';
...
$string['privacy:metadata:upload_session:title']        = 'The title the uploader gave the video';
$string['privacy:metadata:upload_session:timecreated']  = 'When the upload session was started';
$string['privacy:metadata:webhook_event']                  = 'FastPix webhook events retained for idempotency and ordering (pruned after 90 days)';
$string['privacy:metadata:webhook_event:provider_event_id'] = 'The FastPix-side event identifier';
$string['privacy:metadata:webhook_event:event_type']       = 'The type of webhook event (e.g. video.media.ready)';
$string['privacy:metadata:webhook_event:payload']          = 'The raw event payload from FastPix (asset metadata, no Moodle user data)';
$string['privacy:metadata:webhook_event:received_at']      = 'When the event was received';
...
$string['setting_enablehealthendpoint']     = 'Enable public health endpoint';
$string['setting_enablehealthendpoint_desc'] = 'When enabled, /local/fastpix/health.php answers unauthenticated, rate-limited liveness probes (for uptime monitoring). Disable to return 404 to anonymous callers.';
$string['settings_retention']               = 'Retention & cleanup';
$string['settings_retention_desc']          = 'Controls when abandoned uploads and unattached videos are swept. Warning lead must be shorter than the grace period.';
$string['setting_orphaned_session_ttl']     = 'Stale upload-session lifetime';
$string['setting_orphaned_session_ttl_desc'] = 'How long an upload session that never progressed to a video is kept before the orphan sweeper cancels the FastPix upload and deletes the session row. Default 24 hours.';
$string['setting_unattached_grace']         = 'Unattached video grace period';
$string['setting_unattached_grace_desc']    = 'How long a ready video may stay unattached to any activity before it is released (soft-deleted, then permanently removed by the 7-day purge). Default 7 days.';
$string['setting_unattached_warning_lead']  = 'Unattached video warning lead time';
$string['setting_unattached_warning_lead_desc'] = 'How long before release the owner is warned that an unattached video will be removed, giving them time to attach it. Must be less than the grace period. Default 2 days.';
$string['setting_auto_release_enabled']     = 'Automatically remove unattached videos';
$string['setting_auto_release_enabled_desc'] = 'When enabled, ready videos that have no activity reference and have not been rendered anywhere for the grace period are soft-deleted (then permanently removed by the purge). When disabled (the default), owners are only notified and nothing is deleted automatically. Leave disabled until filter_fastpix and tinymce_fastpix report video usage, otherwise an embedded video could be removed.';
$string['messageprovider:unattached_asset_released'] = 'Warning that an unused FastPix video will be removed';
$string['message_unattached_subject']       = 'A FastPix video appears unused';
$string['message_unattached_body']          = 'Your FastPix video "{$a->title}" is not attached to any activity and has not been viewed recently. It will be permanently removed in about {$a->days} day(s) unless you add it to an activity before then.';
$string['message_unattached_review']        = 'Your FastPix video "{$a->title}" is not attached to any activity and has not been viewed recently. You may want to attach it to an activity or remove it to free up storage.';
