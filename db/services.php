...
// Repeated literals hoisted to a single source (S1192). The 'execute' method
// name, the uploadmedia capability, and the 'write' type each recur across the
// definitions below.
$execute    = 'execute';
$capupload  = 'mod/fastpix:uploadmedia';
$typewrite  = 'write';
